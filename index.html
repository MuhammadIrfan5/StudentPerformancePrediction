	...
	<header id="header">
		<div class="container">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
				<h3 class="wow fadeIn text-white" data-wow-duration="1s" data-wow-delay=".3s">Edupredict</h3>
					<!--<a href="index.php"><img src="img/logo.png" alt="" title="" /></a>-->
				</div>
				<nav id="nav-menu-container">
				<a href="student/index.php" data-wow-duration="1s" data-wow-delay=".3s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Login as Student</a>
			    <a href="instructor/index.php" data-wow-duration="1s" data-wow-delay=".3s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Login as Instructor</a>
					<!--img/logo.png
					student/index.php
		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center justify-content-center">
				<div class="banner-content col-lg-8 col-md-12">
					<h1 class="wow fadeIn" data-wow-duration="4s">Student Performance <br> Prediction  Model</h1>
					<p class="text-white">
					...
					<div class="input-wrap">
						<form action="" class="form-box d-flex justify-content-between">
							<input type="text" placeholder="Enter Email" class="form-control" name="username">
							<button type="submit" class="btn search-btn">Subscribe</button>
						</form>
					</div>
					<h4 class="text-white">Functionalities</h4>

					<div class="courses pt-20">
						<a href="#" data-wow-duration="1s" data-wow-delay=".3s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Predicts</a>
						<a href="#" data-wow-duration="1s" data-wow-delay=".6s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Register Course</a>
						<a href="#" data-wow-duration="1s" data-wow-delay=".9s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Graphs</a>
						<a href="#" data-wow-duration="1s" data-wow-delay="1.2s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Performance
							
						</a>
						<a href="#" data-wow-duration="1s" data-wow-delay="1.5s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Analysis</a>
		...
		<div class="container">
			<div class="row align-items-center justify-content-center">
				...
				<div class="offset-lg-1 col-lg-6 offset-md-0 col-md-12 about-right">
					...
					<!--<a href="inde.php" class="primary-btn">Subscribe</a>-->
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row align-items-center">
				...
				<div class="offset-lg-1 col-lg-6">
					<div class="courses-right">
						<div class="row">
							<img class="img-fluid" src="img/ml_image.png" alt="">
			...
			<div class="row justify-content-center d-flex align-items-center">
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty" >
					<div class="thumb d-flex justify-content-center" >
						<img class="rounded-circle" src="img/faculty/f1.jpg" alt="" >
					</div>
					<div class="meta-text text-center">
						<h4>Muhammad Irfan</h4>
						<p class="designation">Group Lead</p>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
					<div class="thumb d-flex justify-content-center">
						<img class="rounded-circle" src="img/faculty/f2.jpg" alt="">
					</div>
					<div class="meta-text text-center">
						<h4>Shakir Abbas</h4>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
					<div class="thumb d-flex justify-content-center">
						<img class="rounded-circle" src="img/faculty/f4.jpg" alt="">
					</div>
					<div class="meta-text text-center">
						<h4>Marium Attaullah</h4>
						<p class="designation">Team Member</p>
