                        ...
                        <form method="POST" enctype="multipart/form-data" id="loginForm">
                            <div class="row">
								...
								<div class="form-group col-lg-12">
                                    ...
                                    <input class="form-control" placeholder="First Name" name="lname" >
                                </div>
								<div class="form-group col-lg-12">
                                ...
                                <div class="checkbox col-lg-12">
                                    <input type="checkbox" class="i-checks" checked> Sigh up
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-success loginbtn" name="btn_register">Register</button>
...
<?php
	if(isset($_POST["btn_register"]))
	{
		...
		//echo $_POST["uloc"];
		$students->register_student($std_array);
	}
?>