                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">MidTerm List</a></li>
	 ...
	 <div class="edu-accordion-area mg-b-15">
		<div class="container-fluid">
			...
			<label>Select Course</label>
				<select data-placeholder="Choose a Course..." id="c_id" OnChange="loadmid(this.value,this)" name="course_name" class="chosen-select form-control" tabindex="-1">
...
function loadmid(id,obj){
	...
	//	alert("count is 2 and id is "+id);
		...
		//alert("count is 3 and id is "+id);
        xmlhttp.open("GET", "../includes/classes/ajax_delete.php?id="+id+"&cases=loadmid",false);//alert("count is 4 and id is "+id);
        xmlhttp.send();//alert("count is 5 and id is "+id);
		return status;
    }
...
xmlhttp.onreadystatechange = function() {
	if (this.readyState == 4 && this.status == 200) {
        ...
        xmlhttp.open("GET", "../includes/classes/ajax_delete.php?id="+id+"&cases=delete_mid",false);
        xmlhttp.send();
		return status;
    }
