                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Add Mid</a></li>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="mid_title" type="text" class="form-control" placeholder="Mid Title">
                                                                </div>
                                                                <!--<div class="form-group">
																...
																<label>Mid Timing</label>
                                                                    <input id="timing" name="mid_time" type="time" class="form-control" placeholder="Time">
                                                                </div>
                                                                <div class="form-group">
																<label>Mid Date</label>
                                                                    <input name="mid_date" type="date" class="form-control">
                                                                </div>
																<div class="form-group">
                                                                    <input name="mid_total_marks" type="number" class="form-control" placeholder="Mid Total Marks">
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																...
																<div class="form-group">
                                                                    <textarea name="mid_desc" placeholder="Mid Description"></textarea>
                                                                </div>
															<div class="bt-df-checkbox pull-left">
																<div class="i-checks pull-left">
																	<input type="checkbox" value="1" name="mid_sts"> <i></i> Visibility </label>
																</div>
															</div>	
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" name="btn_add_mid" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
...
<?php
	if(isset($_POST["btn_add_mid"]))
	{
		...
		//echo $_POST["uloc"];
		$mids->add_mid($mid_array,$_SESSION["inst_id"]);
	}
?>
<script>
