                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="quiz_title" type="text" class="form-control" placeholder="Quiz Title">
                                                                </div>
                                                                <!--<div class="form-group">
																...
																<label>Quiz Timing</label>
                                                                    <input id="timing" name="quiz_time" type="time" class="form-control" placeholder="Time">
                                                                </div>
                                                                <div class="form-group">
																<label>Quiz Date</label>
                                                                    <input name="quiz_date" type="date" class="form-control">
                                                                </div>
																<div class="form-group">
                                                                    <input name="quiz_total_marks" type="number" class="form-control" placeholder="Quiz Total Marks">
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																...
																<div class="form-group">
                                                                    <textarea name="quiz_desc" placeholder="Quiz Description"></textarea>
                                                                </div>
															<div class="bt-df-checkbox pull-left">
																<div class="i-checks pull-left">
																	<input type="checkbox" value="1" name="quiz_sts"> <i></i> Visibility </label>
																</div>
															</div>	
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" name="btn_add_quiz" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
...
<?php
	if(isset($_POST["btn_add_quiz"]))
	{
		...
		//echo $_POST["uloc"];
		$quiz->add_quiz($quiz_array,$_SESSION["inst_id"]);
	}
?>
<script>
