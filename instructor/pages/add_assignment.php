                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="assign_title" type="text" class="form-control" placeholder="Assignment Title">
                                                                </div>
                                                                <!--<div class="form-group">
																...
																<label>Starts From</label>
                                                                    <input name="assign_start_date" type="date" class="form-control">
                                                                </div>
																<div class="form-group">
																<label>Ends At</label>
                                                                    <input name="assign_end_date" type="date" class="form-control">
                                                                </div>
																...
																<label>Ends at Timing</label>
                                                                    <input id="timing" name="assign_time" type="time" class="form-control" placeholder="Time">
                                                                </div>
																<div class="form-group">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																<select data-placeholder="Choose a Course..."id="c_id" name="course_name" class="chosen-select form-control" tabindex="-1">
																	<option value='' disabled selected>Choose Course</option>
																	<?php //echo $courses->list_course_dropdown($_SESSION['inst_id']); ?>
																</select>
																<div class="form-group">
                                                                    <textarea name="assign_desc" placeholder="Assignment Description"></textarea>
                                                                </div>
																<div class="form-group">
                                                                    <input name="assign_total_marks" type="number" class="form-control" placeholder="Assignment Total Marks">
                                                                </div>
															<div class="bt-df-checkbox pull-left">
																<div class="i-checks pull-left">
																	<input type="checkbox" value="1" name="assign_sts"> <i></i> Visibility </label>
																</div>
															</div>	
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" name="btn_add_assignment" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
...
<?php
	if(isset($_POST["btn_add_assignment"]))
	{
		...
		//echo $_POST["uloc"];
		$assignments->add_assignment($assign_array,$_SESSION["inst_id"]);
	}
?>
 <script>
