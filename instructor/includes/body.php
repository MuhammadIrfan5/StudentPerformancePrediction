                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Classes</h5>
                                <h2>$<span class="counter">100</span> <span class="tuition-fees">Tuition Fees</span></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Professors</h5>
                                <h2>$<span class="counter">150</span> <span class="tuition-fees">Tuition Fees</span></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                <h5>Students</h5>
                                <h2>$<span class="counter">25000</span> <span class="tuition-fees">Tuition Fees</span></h2>
